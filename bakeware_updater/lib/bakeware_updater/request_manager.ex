defmodule BakewareUpdater.RequestManager do
  use GenServer
  ...
  def check_for_update(exec_name, version, timeout \\ 5000) do
    # Use default update server
    # TODO: Support passing URI to hit other update server?
    uri = URI.parse("https://sous-chef.jonjon.dev/api/check/#{exec_name}/#{os_type()}?version=#{version}")
